...
class SupervisedDataset(Dataset):
    ...
    def __getitem__(self, i) -> Dict[str, torch.Tensor]:
        ...
        if "image" in sources:
            ...
            subtitles_folder = self.data_args.video_subtitles_folder
            ...
            for video_file in video_files:
                if subtitles_folder:
                    subtitle_file = os.path.join(subtitles_folder, video_file)
                ...
                video_input, video_kwargs = get_video_info(video_file, subtitle_file, self.video_min_pixel, self.video_max_pixel, self.video_resized_w, self.video_resized_h, self.data_args.fps)
